...
type BlockContext struct {
	...
	BaseFee     *big.Int       // Provides information for BASEFEE (0 if evm runs with NoBaseFee flag and 0 gas price)
	BlobBaseFee *big.Int       // Provides information for BLOBBASEFEE (0 if evm runs with NoBaseFee flag and 0 blob gas price)
...
func NewEVM(
	...
	evm.interpreter = NewEVMInterpreter(evm, record, chainId)
	return evm
}
